      ...
      <Container className="solidBGPage">
        <Row className='py-5'>
          ...
          <Col sm={7} className="ps-5 pe-5">
              ...
              <div className="deskCompJSeekProfile mb-5">Description before hire Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut</div>
              ...
              <Form>
                ...
                <Form.Group className="mb-3 pSideBarProfile" controlId="purpose">
                  ...
                  <Form.Select size="md" aria-label="Default select example" style={{color: "gray"}}>
                    ...
                    <option style={{color: "black"}} value="1">ProjectOne</option>
                    <option style={{color: "black"}} value="2">ProjectTwo</option>
                    <option style={{color: "black"}} value="3">ProjectThree</option>
                  </Form.Select>
                </Form.Group>
